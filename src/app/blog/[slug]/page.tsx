...
const articles: Record<string, { title: string; excerpt: string; category: string; readTime: string; date: string; content: string[] }> = {
  "guide-complet-climatisation-2026": {
    ...
    content: [
      ...
      "Le prêt à poser, c'est notre spécialité : vous recevez tout le matériel nécessaire, avec des guides d'installation clairs. Vous pouvez installer vous-même en un week-end, ou faire appel à nos installateurs qualifiés.",
